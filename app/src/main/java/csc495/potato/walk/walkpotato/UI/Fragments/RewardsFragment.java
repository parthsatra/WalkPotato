...
public class RewardsFragment extends Fragment {
    ...
    private void initCards() {
        ...
        for (int i=0;i<100;i++){
            ...
            card.setTitle("Reward for Company " + i);
            card.setSecondaryTitle("Company " + i);
    ...
    public class GooglePlaySmallCard extends Card {
        ...
        public GooglePlaySmallCard(Context context) {
            this(context, R.layout.inner_rewards_card);
        }
        ...
        private void init() {
            ...
            if (resourceIdThumbnail==0)
                cardThumbnail.setDrawableResource(R.drawable.mascot);
            else{
